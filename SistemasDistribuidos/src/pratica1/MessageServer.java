...
class Connection extends Thread {
	...
	public void run() {
		try {
			...
			if (msg2.trim().equals(Integer.toString(random4digits))) {
				System.out.println(currentTime() + "Codigo correto de " + msg1 + "!");
			} else {
				System.out.println(currentTime() + "Codigo incorreto de " + msg1 + "!");
			}
